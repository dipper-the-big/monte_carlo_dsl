...
#ifndef GKMC_SystemSingle_H
#define GKMC_SystemSingle_H
...
template <class SystemProps, class Hook, class Type> class SystemSingle {
public:
  ...
  using SystemTupleT = particleM<Type>;
  SystemTupleT _particles;
...
public:
  ...
  SystemSingle(SystemProps sysProps, Hook hook)
